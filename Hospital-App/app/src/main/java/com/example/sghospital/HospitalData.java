...
public class HospitalData extends SQLiteOpenHelper {
    ...
    public static final String COL_HOSPITAL_DATE = "HOSPITAL_DATE";
    ...
    public void onCreate(SQLiteDatabase db) {
        String create = "CREATE TABLE " + HOSPITAL_TABLE + "(" + COL_HOSPITAL_NAME + " TEXT," + COL_HOSPITAL_AGE + " TEXT," + COL_HOSPITAL_ADDRESS + " TEXT," + COL_HOSPITAL_PHONE + " TEXT PRIMARY KEY,"  + COL_HOSPITAL_EMAIL + " TEXT," + COL_HOSPITAL_DATE + " TEXT"+ ")";
        db.execSQL(create);
    }
    @Override
    ...
    public boolean addOne(Models models) {
        ...
        cv.put(COL_HOSPITAL_DATE, models.getDate());
        long insert;
    ...
    public List<Models> getEveryone() {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                String patientDate = cursor.getString(5);
                Models models = new Models(patientName, patientAge, patientAddress, patientPhone, patientEmail, patientDate);
