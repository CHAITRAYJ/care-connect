...
Button bSubmit;
EditText edName,edAge,edAddress,edPhone,edEmail,edDate;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Models models;
                try {
                    models = new Models(edName.getText().toString(), edAge.getText().toString(), edAddress.getText().toString(), edPhone.getText().toString(), edEmail.getText().toString(),edAge.getText().toString());
                   ...
                   models=new Models("error","error","error","error","error","error");
                }
                boolean success;
